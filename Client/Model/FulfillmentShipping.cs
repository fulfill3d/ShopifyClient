...
namespace Client.Model
{
    ...
    public class FulfillmentShipping
    {
        ...
        /// </summary>
        [JsonProperty("tracking_info")] public TrackingInfo TrackingInfo { get; set; }
        ...
        /// </summary>
        [JsonProperty("line_items_by_fulfillment_order")] public IEnumerable<LineItemsByFulfillmentOrder> FulfillmentRequestOrderLineItems { get; set; }
    }
}
