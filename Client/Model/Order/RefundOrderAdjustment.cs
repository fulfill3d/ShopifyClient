...
namespace Client.Model.Order
{
    public class RefundOrderAdjustment : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("refund_id")] public long? RefundId { get; set; }
        ...
        /// </summary>public string Reason { get; set; }
        ...
        /// </summary>
        [JsonProperty("tax_amount_set")] public PriceSet TaxAmountSet { get; set; }
    }
}