...
namespace Client.Model.Order
{
    public class ShippingLine
    {
        ...
        /// </summary>
        [JsonProperty("carrier_identifier")] public string CarrierIdentifier { get; set; }
        ...
        /// </summary>
        [JsonProperty("discounted_price")] public decimal? DiscountedPrice { get; set; }
        ...
        /// </summary>
        [JsonProperty("discounted_price_set")] public PriceSet DiscountedPriceSet { get; set; }
    }
}