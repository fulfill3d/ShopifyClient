...
namespace Client.Model.Order
{
    public class Refund : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("order_adjustments")] public IEnumerable<RefundOrderAdjustment> OrderAdjustments { get; set; }
        ...
        [JsonProperty("discrepancy_reason")] public string DiscrepancyReason { get; set; }

        /// <summary>
        /// The list of <see cref="RefundLineItem"/> objects
        /// </summary>
        [JsonProperty("refund_line_items")] public IEnumerable<RefundLineItem> RefundLineItems { get; set; }
        ...
        /// </summary>
        [JsonProperty("duties")] public IEnumerable<RefundDuty> Duties { get; set; }

        /// <summary>
        /// A list of refunded duties
        /// </summary>
        [JsonProperty("refund_duties")] public IEnumerable<RefundDutyType> RefundDuties { get; set; }
    ...
    public class Shipping
    {
        ...
        /// </summary>
        [JsonProperty("full_refund")] public bool? FullRefund { get; set; }
        ...
        /// </summary>
        [JsonProperty("maximum_refundable")] public decimal? MaximumRefundable { get; set; }
    }
}