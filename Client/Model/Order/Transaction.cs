...
namespace Client.Model.Order
{
    ...
    public class Transaction : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("source_name")] public string SourceName { get; private set; }
        ...
        /// </summary>
        [JsonProperty("currency_exchange_adjustment")] public CurrencyExchangeAdjustment CurrencyExchangeAdjustment { get; set; }
    }
}