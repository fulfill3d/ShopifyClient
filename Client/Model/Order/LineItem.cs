...
namespace Client.Model.Order
{
    public class LineItem : ShopifyObject
    {
        ...
        /// <summary>
        /// POD.Common.Service provider who is doing the fulfillment. Valid values are either "manual" or the name of the provider. eg: "amazon", "shipwire", etc.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("tip_payment_gateway")] public string TipPaymentGateway { get; set; }

        /// <summary>
        /// The payment method used to tender the tip, such as Visa. Present only on tips.
        /// </summary>
        [JsonProperty("tip_payment_method")] public string TipPaymentMethod { get; set; }
        ...
        /// </summary>
        [JsonProperty("total_discount_set")] public PriceSet TotalDiscountSet { get; set; }
        ...
        /// </summary>
        [JsonProperty("discount_allocations")] public IEnumerable<DiscountAllocation> DiscountAllocations { get; set; }
        ...
        /// </remarks>
        [JsonProperty("properties")] public IEnumerable<LineItemProperty> Properties { get; set; }
        ...
        /// </summary>
        [JsonProperty("price_set")] public PriceSet PriceSet { get; set; }

        /// <summary>
        /// A list of duty objects, each containing information about a duty on the line item
        /// </summary>
        [JsonProperty("duties")] public IEnumerable<LineItemDuty> Duties { get; set; }

        /// <summary>
        /// The location of the line item's fulfillment origin.
        /// </summary>
        [JsonProperty("origin_location")] public LineItemOriginLocation OriginLocation { get; set; }
    }
}
