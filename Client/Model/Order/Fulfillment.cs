...
namespace Client.Model.Order
{
    ...
    public class Fulfillment : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("receipt")] public object Receipt { get; set; }
        ...
        /// </summary>
        [JsonProperty("destination")] public Address Destination { get; set; }
        ...
        /// </summary>
        [JsonProperty("tracking_numbers")] public IEnumerable<string> TrackingNumbers { get; set; }
        ...
        /// </summary>
        [JsonProperty("tracking_urls")] public IEnumerable<string> TrackingUrls { get; set; }
        ...
        /// This property is undocumented by Shopify.
        /// </summary>
        [JsonProperty("shipment_status")] public string ShipmentStatus { get; set; }
        ...
        /// </summary>
        [JsonProperty("origin_address")] public Address OriginAddress { get; set; }
    }
}
