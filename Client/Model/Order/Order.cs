...
namespace Client.Model.Order
{
    public class Order : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("cancelled_at")] public DateTimeOffset? CancelledAt { get; set; }
        ...
        /// </summary>
        [JsonProperty("client_details")] public ClientDetails ClientDetails { get; set; }
        ...
        /// </summary>
        [JsonProperty("customer_locale")] public string CustomerLocale { get; set; }
        ...
        /// </summary>
        [JsonProperty("discount_codes")] public IEnumerable<DiscountCode> DiscountCodes { get; set; }
        ...
        /// </summary>
        [JsonProperty("discount_applications")] public IEnumerable<DiscountApplication> DiscountApplications { get; set; }
        ...
        /// </summary>
        [JsonProperty("fulfillments")] public IEnumerable<Fulfillment> Fulfillments { get; set; }
        ...
        /// </summary>
        [JsonProperty("line_items")] public IEnumerable<LineItem> LineItems { get; set; }
        ...
        /// </summary>
        [JsonProperty("note_attributes")] public IEnumerable<NoteAttribute> NoteAttributes { get; set; }
        ...
        /// </summary>
        [JsonProperty("order_number")] public int? OrderNumber { get; set; }

        /// <summary>
        /// The URL pointing to the order status web page. The URL will be null unless the order was created from a checkout.
        /// </summary>
        [JsonProperty("order_status_url")] public string OrderStatusUrl { get; set; }

        /// <summary>
        /// The list of all payment gateways used for the order.
        /// </summary>
        [JsonProperty("payment_gateway_names")] public IEnumerable<string> PaymentGatewayNames { get; set; }
        ...
        /// </summary>
        [JsonProperty("refunds")] public IEnumerable<Refund> Refunds { get; set; }
        ...
        /// </summary>
        [JsonProperty("shipping_lines")] public IEnumerable<ShippingLine> ShippingLines { get; set; }
        ...
        /// </summary>
        [JsonProperty("total_tip_received")] public decimal? TotalTipReceived { get; set; }
        ...
        /// </summary>
        [JsonProperty("total_weight")] public long? TotalWeight { get; set; }
        ...
        /// this order.
        /// </summary>
        [JsonProperty("transactions")] public IEnumerable<Transaction> Transactions { get; set; }
        ...
        /// </summary>
        [JsonProperty("metafields")] public IEnumerable<MetaField> Metafields { get; set; }

        /// <summary>
        /// The current total duties charged on the order in shop and presentment currencies.
        /// </summary>
        [JsonProperty("current_total_duties_set")] public PriceSet CurrentTotalDutiesSet { get; set; }

        /// <summary>
        /// The original total duties charged on the order in shop and presentment currencies.
        /// </summary>
        [JsonProperty("original_total_duties_set")] public PriceSet OriginalTotalDutiesSet { get; set; }

        /// <summary>
        /// The three letter code (ISO 4217) for the currency used used to display prices to the customer.
        /// </summary>
        [JsonProperty("presentment_currency")] public string PresentmentCurrency { get; set; }

        /// <summary>
        /// The total of all line item prices in shop and presentment currencies.
        /// </summary>
        [JsonProperty("total_line_items_price_set")] public PriceSet TotalLineItemsPriceSet { get; set; }

        /// <summary>
        /// The total discounts applied to the price of the order in shop and presentment currencies.
        /// </summary>
        [JsonProperty("total_discounts_set")] public PriceSet TotalDiscountsSet { get; set; }
        ...
        /// </summary>
        [JsonProperty("total_shipping_price_set")] public PriceSet TotalShippingPriceSet { get; set; }

        /// <summary>
        /// The subtotal of the order in shop and presentment currencies.
        /// </summary>
        [JsonProperty("subtotal_price_set")] public PriceSet SubtotalPriceSet { get; set; }

        /// <summary>
        /// The total price of the order in shop and presentment currencies.
        /// </summary>
        [JsonProperty("total_price_set")] public PriceSet TotalPriceSet { get; set; }
        ...
        /// </summary>
        [JsonProperty("estimated_taxes")] public bool? EstimatedTaxes { get; set; }
    }
}
