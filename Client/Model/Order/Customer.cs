...
namespace Client.Model.Order
{
    public class Customer : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("addresses")] public IEnumerable<Address> Addresses { get; set; }
        ...
        /// </summary>
        [JsonProperty("default_address")] public Address DefaultAddress { get; set; }
        ...
        /// </summary>
        [JsonProperty("orders_count")] public int? OrdersCount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tax_exempt")] public bool? TaxExempt { get; set; }
        
        /// <summary>
        /// Whether the customer is exempt from paying specific taxes on their order. Canadian taxes only
        /// </summary>
        [JsonProperty("tax_exemptions")] public string[] TaxExemptions { get; set; }
