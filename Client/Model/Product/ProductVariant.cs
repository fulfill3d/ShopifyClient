...
namespace Client.Model.Product
{
    public class ProductVariant : ShopifyObject
    {
        ...
        /// <summary>
        /// POD.Common.Service that is doing the fulfillment. Can be 'manual' or any custom string.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("compare_at_price", DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)] public decimal? CompareAtPrice { get; set; }
        ...
        /// </summary>
        [JsonProperty("image_id", DefaultValueHandling = DefaultValueHandling.Ignore)] public long? ImageId { get; set; }
