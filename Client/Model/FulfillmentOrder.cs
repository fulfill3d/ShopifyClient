...
namespace Client.Model
{
    ...
    public class FulfillmentOrder : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("request_status")] public string RequestStatus { get; set; }
        ...
        /// </summary>
        [JsonProperty("destination")] public FulfillmentOrderDestination FulfillmentOrderDestination { get; set; }

        /// <summary>
        /// Represents line items belonging to a fulfillment order:
        /// </summary>
        [JsonProperty("line_items")] public IEnumerable<FulfillmentOrderLineItem> FulfillmentOrderLineItems { get; set; }
        ...
        /// </summary>
        [JsonProperty("supported_actions")] public IEnumerable<string> SupportedActions { get; set; }

        /// <summary>
        /// Followings actions can be performed on this fulfillment order.
        /// </summary>
        [JsonProperty("outgoing_requests")] public IEnumerable<OutgoingRequest> OutgoingRequests { get; set; }

        /// <summary>
        /// A list of requests sent by the merchant to the fulfillment service for this fulfillment order.
        /// </summary>
        [JsonProperty("merchant_requests")] public IEnumerable<MerchantRequest> MerchantRequests { get; set; }

        /// <summary>
        /// The fulfillment order's assigned location
        /// </summary>
        [JsonProperty("assigned_location")] public AssignedLocation AssignedLocation { get; set; }

        /// <summary>
        /// The type of method used to transfer a product or service to a customer
        /// </summary>
        [JsonProperty("delivery_method")] public DeliveryMethod DeliveryMethod { get; set; }
        ...
        /// </summary>
        [JsonProperty("fulfill_at")] public DateTimeOffset? FulfillAt { get; set; }

        /// <summary>
        /// The latest date and time by which all items in the fulfillment order need to be fulfilled.
        /// </summary>
        [JsonProperty("fulfill_by")] public DateTimeOffset? FulfilledBy { get; set; }

        /// <summary>
        /// A list of requests sent by the merchant to the fulfillment service for this fulfillment order.
        /// </summary>
        [JsonProperty("fulfillment_holds")] public IEnumerable<FulfillmentHold> FulfillmentHolds { get; set; }
        ...
        /// </summary>
        [JsonProperty("international_duties")] public FulfillmentInternationalDuties InternationalDuties { get; set; }
