...
namespace Client.Model
{
    ...
    public class FulfillmentService : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("inventory_management")] public bool? InventoryManagement { get; set; }
        ...
        /// </summary>
        [JsonProperty("requires_shipping_method")] public bool? RequiresShippingMethod { get; set; }

        /// <summary>
        /// States if the fulfillment service provides tracking numbers for packages.
        /// </summary>
        [JsonProperty("tracking_support")] public bool? TrackingSupport { get; set; }
        ...
        /// This property is undocumented by Shopify.
        /// </summary>
        [JsonProperty("include_pending_stock")] public bool? IncludePendingStock { get; set; }
        ...
        /// </summary>
        [JsonProperty("fulfillment_orders_opt_in")] public bool? FulfillmentOrdersOptIn { get; set; }

        /// <summary>
        /// Whether the fulfillment service can stock inventory alongside other locations.
        /// </summary>
        [JsonProperty("permits_sku_sharing")] public bool? PermitsSkuSharing { get; set; }
