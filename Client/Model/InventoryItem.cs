...
namespace Client.Model
{
    public class InventoryItem : ShopifyObject
    {
        ...
        /// </summary>
        [JsonProperty("tracked")] public bool? Tracked { get; set; }
        ...
        /// </summary>
        [JsonProperty("province_code_of_origin")] public string ProvinceCodeOfOrigin { get; set; }
        ...
        /// </summary>
        [JsonProperty("country_harmonized_system_codes")] public IEnumerable<HSCode> CountryHarmonizedSystemCodes { get; set; }
